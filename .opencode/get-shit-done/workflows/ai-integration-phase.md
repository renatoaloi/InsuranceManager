...
<required_reading>
@C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/ai-frameworks.md
@C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-eval-planner.md for instructions.
