...
```bash
INIT=$(node "C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/spec.md.
