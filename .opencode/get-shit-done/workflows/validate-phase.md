...
```
Agent(
  prompt="Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/VALIDATION.md`
