...
```markdown
Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-ui-checker.md for instructions.
