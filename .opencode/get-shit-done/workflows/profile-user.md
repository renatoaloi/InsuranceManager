...
Key references:
- @C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/USER-PROFILE.md" "C:/dev/INDT/InsuranceManager/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/dev/INDT/InsuranceManager/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/dev/INDT/InsuranceManager/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/dev/INDT/InsuranceManager/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="C:/dev/INDT/InsuranceManager/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/dev/INDT/InsuranceManager/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        C:/dev/INDT/InsuranceManager/.opencode/AGENTS.md
```
