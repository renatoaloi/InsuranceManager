...
```
Agent(
  prompt="Read C:/dev/INDT/InsuranceManager/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/SECURITY.md`
