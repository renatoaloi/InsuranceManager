...
INSTALL_JS_GLOBAL="C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
