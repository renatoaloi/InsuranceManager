...
<required_reading>
@C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/dev/INDT/InsuranceManager/.opencode
                  → checks C:/dev/INDT/InsuranceManager/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/dev/INDT/InsuranceManager/.opencode/get-shit-done
                  → writes to C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/hooks/
...
@C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/references/common-bug-patterns.md
