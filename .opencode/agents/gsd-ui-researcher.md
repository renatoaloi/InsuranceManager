...
Use template from `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/UI-SPEC.md`
