...
Reference full template: `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/dev/INDT/InsuranceManager/.opencode/get-shit-done/templates/state.md`.
